(self.TURBOPACK = self.TURBOPACK || []).push(["chunks/[embedded_modules]_@vercel_turbopack-next_internal_ipc.ts.js", {

"[project-with-next]/[embedded_modules]/@vercel/turbopack-next/internal/ipc.ts (ecmascript)": (({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname }) => (() => {

__turbopack_esm__({
    "default": ()=>__TURBOPACK__default__export__
});
var __TURBOPACK__external__node$3a$net__ = __turbopack_external_require__("node:net");
var __TURBOPACK__imported__module__$5b$project$2d$with$2d$next$5d2f5b$embedded_modules$5d2f40$vercel$2f$turbopack$2d$next$2f$internal$2f$error$2e$ts__ = __turbopack_import__("[project-with-next]/[embedded_modules]/@vercel/turbopack-next/internal/error.ts (ecmascript)");
...
"[project-with-next]/[embedded_modules]/@vercel/turbopack-next/internal/error.ts (ecmascript)": (({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname }) => (() => {
...
//# sourceMappingURL=[embedded_modules]_@vercel_turbopack-next_internal_ipc.ts.js.map